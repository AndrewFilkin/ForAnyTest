...
@push('custom-scripts')
    <script type="text/javascript" src="{{ URL::asset('my-js/ForChat/main.js')}}"></script>
@endpush
@push('custom-style')
    <link rel="stylesheet" href="{{ URL::asset('css/styleForChat/chatStyle.css')}}">
@endpush
@section('body')
    <main class="content">
                    ...
                    <div class="col-12 col-lg-7 col-xl-9">
                            ...
                            <div class="chat-messages p-4" id="chat-messages">
                                ...
                                <div class="chat-message-left pb-4">
                                    ...
                                    <div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                        <div class="font-weight-bold mb-1">Sharon Lessman1234</div>
                        ...
                        <div class="flex-grow-0 py-3 px-4 border-top">
                            <div class="input-group">
                                    <input type="text" name="searchTxt" id="searchTxt" class="form-control" placeholder="Type your message">
                                    <button class="btn btn-primary" onclick="addRow()">Send</button>
                            </div>
                        </div>
