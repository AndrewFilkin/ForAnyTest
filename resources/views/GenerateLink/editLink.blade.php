...
@section('body')
    <form class="col-lg-6 offset-lg-3" method="POST" action="{{url('/upgrade-short-link/'.$items->code)}}">
        @csrf
        @method('PUT')
        <div class="row justify-content-center">
            <div class="form-group">
                <label for="name">Main Link</label>
                <input type="text" class="form-control" id="main_link" name="main_link" value="{{$items->main_link}}">
            </div>
